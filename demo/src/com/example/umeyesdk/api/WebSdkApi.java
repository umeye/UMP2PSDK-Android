...
public class WebSdkApi {
	 ...
	 * 
	 * @param pc
	 * @param userName 用户ID 必填  24位 , 限定字母，数字，下划线
	 *            必填
	 * @param password
					...
					public void handleMessage(Message msg) {
						...
						if (responseCommon != null && responseCommon.h != null) {
							if (responseCommon.h.e == 200) {
								...
								Log.e(WebSdkApi, "登录失败!code=" + responseCommon.h.e);
					...
					public void handleMessage(Message msg) {
						...
						if (responseCommon != null && responseCommon.h != null) {
							if (responseCommon.h.e == 200) {
								...
								Log.e(WebSdkApi, "注册失败!code=" + responseCommon.h.e);
	 ...
	 * 
	 * @param pc
	 * @param oldPassword   20位 , 限定字母，数字，下划线
	 *            旧密码
	 * @param newPassword   20位 , 限定字母，数字，下划线
	 *            新密码
	 */
				...
				new Handler() {
					...
					public void handleMessage(Message msg) {
						...
						if (responseDevList != null
							...
							Log.e(WebSdkApi, "获取设备列表失败! error="
									+ msg.what);
							handler.sendEmptyMessage(Constants.GET_DEVLIST_F);
						}
						super.handleMessage(msg);
	 ...
	 * 
	 * @param pc
	 * @param node_name    		长度 28 限定中文，字母，数字，下划线
	 *            名称
	 * @param parent_node_id	
	 *            父节点ID
	 * @param node_type
	 ...
	 * @param dev_umid          长度28 限定字母，数字，下划线
	 *            设备umid   
	 * @param dev_addr
	 *            设备IP或者域名   长度127
	 * @param dev_port
			...
			public void handleMessage(Message msg) {
				...
				if (responseCommon != null && responseCommon.h != null) {
					if (responseCommon.h.e == 200) {
						...
						Log.e(WebSdkApi, " 删除设备设备集合失败!code="
								+ responseCommon.h.e);
						handler.sendEmptyMessage(Constants.DELETE_DEV_F);
					}
				} else {
					Log.e(WebSdkApi, " 删除设备设备集合失败! error=" + msg.what);
					handler.sendEmptyMessage(Constants.DELETE_DEV_F);
				}
				super.handleMessage(msg);
			}
	 ...
	 * @param node_id
	 *            节点ID
	 * @param node_name       28位 限定中文，字母，数字，下划线
	 *            名称
	 * @param dev_umid
					...
					public void handleMessage(Message msg) {
						...
						if (responseCommon != null && responseCommon.h != null) {
							if (responseCommon.h.e == 200) {
								...
								Log.e(WebSdkApi, " 修改设备设备失败!code="	+ responseCommon.h.e);
			...
			public void handleMessage(Message msg) {
				...
				if (responseQueryAlarm != null && responseQueryAlarm.h != null) {
					if (responseQueryAlarm.h.e == 200) {
						...
						Log.e(WebSdkApi, " 查询报警失败!code="+ responseQueryAlarm.h.e);
					}
				} else {
			...
			public void handleMessage(Message msg) {
				...
				if (responseCommon != null
					...
					if (responseCommon.h.e == 200) {
						...
						Log.e(WebSdkApi,"删除所有报警信息失败!code="	+ responseCommon.h.e);
					}
				} else {
	 ...
	 * 修改设备通道号
	 * @param node_id 节点id
	 * @param dev_id  设备id，playNode.node.sDevId 或者 DevItemInfo.dev_id
	 * @param dev_ch_num 设备通道数
	 */
			...
			public void handleMessage(Message msg) {
				...
				if (responseCommon != null && responseCommon.h != null) {
					if (responseCommon.h.e == 200) {
						...
						Log.e(WebSdkApi, " 修改设备通道数失败!code=" + responseCommon.h.e);
	 ...
	 * @param alarm_events 布防事件类型数组，参考 
	 * @param devName      设备名称
