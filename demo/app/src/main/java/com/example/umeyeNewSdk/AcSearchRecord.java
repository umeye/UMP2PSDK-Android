                ...
                case SEARCH_FINISH:
                    ...
                    } else// 打开新的页面
                    {
                        ...
                        if (getIntent().getBooleanExtra("isDownLoad", false)) {
                            ...
                            startTmp.iDay = startTime.day;
                            startTmp.iYear = startTime.year;
                            startTmp.iHour = startTime.hour;
                            startTmp.iMonth = startTime.month;
                            startTmp.iMinute = startTime.minute;
                            startTmp.iSecond = startTime.second;
                            TDateTime endTmp = new TDateTime();
                            endTmp.iDay = endTime.day;
                            endTmp.iYear = endTime.year;
                            endTmp.iHour = endTime.hour;
                            endTmp.iMonth = endTime.month;
                            endTmp.iMinute = endTime.minute;
                            endTmp.iSecond = endTime.second;
                            intent.putExtra("startTime", startTmp);
                            intent.putExtra("endTime", endTmp);
                        }
